...
$lang = array_merge($lang, array(
	...
	'NO_AUTH_PASSWORD_REMINDER'		=> 'Δεν είστε εξουσιοδοτημένοι να ζητήσετε νέο κωδικό πρόσβασης.',
	...
	'PASSWORD_UPDATED'			=> 'Ένας νέος κωδικός πρόσβασης έχει αποσταλεί στη διεύθυνση του ηλεκτρονικού ταχυδρομείου σας.',
