...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'					=> 'Ευχαριστούμε για την εγγραφή σας, ο λογαριασμός σας δημιουργήθηκε. Μπορείτε τώρα να συνδεθείτε με το όνομα μέλους και τον κωδικό πρόσβασής σας.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Ο κωδικός πρόσβασης πρέπει να κυμαίνεται μεταξύ %1$s και %2$s σε μήκος και να περιέχει κεφαλαία-πεζά γράμματα ανακατεμένα και αριθμούς.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Πρέπει να κυμαίνεται μεταξύ %1$s και %2$s.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Ο κωδικός πρόσβασης πρέπει να κυμαίνεται μεταξύ %1$s και %2$s σε μήκος και να περιέχει κεφαλαία-πεζά γράμματα ανακατεμένα.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Ο κωδικός πρόσβασης πρέπει να κυμαίνεται μεταξύ %1$s και %2$s σε μήκος και να περιέχει κεφαλαία-πεζά γράμματα ανακατεμένα, αριθμούς και ειδικά σύμβολα.',
	'PASSWORD'					=> 'Κωδικός πρόσβασης',
	'PASSWORD_ACTIVATED'		=> 'Ο νέος σας κωδικός πρόσβασης έχει ενεργοποιηθεί.',
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'Αν ο λογαριασμός σας υπάρχει, ένας νέος κωδικός έχει αποσταλλεί στην διεύθυνση email σας. Αν δεν λάβετε email, μπορεί να συμβαίνει γιατί σας έχουν θέσει σε κατάσταση αποβολής (ban), ο λογαρισμός σας δεν είναι ενεργοποιημένος, ή δεν επιτρέπεται να αλλάξετε τον κωδικό σας. Επικοινωνήστε με τον διαχειριστή αν ισχύει οποισδήποτε από αυτούς τους λόγους. Επίσης, ελέγξτε το φίλτρο spam σας.',
