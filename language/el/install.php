...
$lang = array_merge($lang, array(
	...
	'PHP_VERSION_REQD_EXPLAIN'			=> 'Το phpBB απαιτεί έκδοση PHP 5.4.0 ή νεώτερη.',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Ο συνιστώμενος τρόπος για την αναβάθμιση της εγκατάστασής σας που αναφέρεται εδώ ισχύει μόνο για το πακέτο αυτόματης αναβάθμισης. Είστε επίσης σε θέση να ενημερώσετε την εγκατάσταση σας χρησιμοποιώντας τις μεθόδους που αναφέρονται μέσα σε έγγραφο INSTALL.html. Τα βήματα για την αυτόματη αναβάθμιση της phpBB3 είναι:</p>

		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Πηγαίνετε στη <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">σελίδα μεταφορτώσεων phpBB.com</a> και κατεβάστε το σωστό συμπιεσμένο αρχείο "Πακέτο Αναβάθμισης phpBB".<br /><br /></li>
			<li>Αποσυμπιέστε το αρχείο.<br /><br /></li>
			<li>Φορτώστε τους πλήρως αποσυμπιεσμένους φακέλους "install" και "vendor" στον ριζικό φάκελο του phpBB σας (εκεί που είναι το config.php).<br /><br /></li>
		</ul>
		...
		<strong><a href="%1$s" title="%1$s">Τώρα ξεκινήσετε τη διαδικασία αναβάθμισης από το πρόγραμμα περιήγησής σας στο φάκελο εγκατάστασης</a>.</strong><br />
		<br />
...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Έχετε πλέον μετατρέψει με επιτυχία το σύστημα συζητήσεών σας σε phpBB 3.2. Μπορείτε τώρα να συνδεθείτε και <a href="../">να έχετε πρόσβαση στο σύστημα συζητήσεών σας</a>. Παρακαλώ βεβαιωθείτε ότι οι ρυθμίσεις μεταφέρθηκαν σωστά πριν από την ενεργοποίηση του συστήματος συζητήσεών σας διαγράφοντας τον καταλόγου εγκατάστασης. Θυμηθείτε ότι η βοήθεια σχετικά με τη χρήση phpBB είναι διαθέσιμη στο διαδίκτυο μέσω των <a href="https://www.phpbb.com/support/docs/en/3.2/ug/">Εγγράφων</a> και στη <a href="https://www.phpbb.com/community/viewforum.php?f=466">Δ. Συζήτηση υποστήριξης</a>.',
