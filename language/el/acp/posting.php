...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		...
		'URL'			=> 'Μια έγκυρη διεύθυνση URL χρησιμοποιώντας οποιοδήποτε επιτρεπόμενο πρωτόκολλο (http, ftp, κλπ… δεν μπορεί να χρησιμοποιηθεί γιατί τα javascript το εκμεταλλεύονται). Εάν δεν έχει δοθεί κανένα, το “http://” προστίθεται στην αρχή της συμβολοσειράς.',
