...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Αυτή η ρύθμιση αντικαθιστά το όριο του φακέλου μηνυμάτων ανά μέλος. Η τιμή 0 σημαίνει ότι το προεπιλεγμένο όριο μέλους θα χρησιμοποιηθεί.',
