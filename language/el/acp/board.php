...
$lang = array_merge($lang, array(
	...
	'SMTP_SERVER'					=> 'Διεύθυνση διακομιστή SMTP και πρωτόκολλο',
	'SMTP_SERVER_EXPLAIN'			=> 'Σημειώστε ότι πρέπει να παρέχετε και το πρωτόκολλο που χρησιμοποιεί ο διακομιστής σας. Αν χρησιμοποιείται SSL, πρέπει να το γράψετε "ssl://your.mailserver.com"',
