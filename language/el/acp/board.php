...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'Η μορφή ημερομηνίας είναι ίδια με αυτή της συνάρτησης PHP <code>date</code>.',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'Αυτές οι λεπτομέρειες καθορίζουν τα δεδομένα που χρησιμοποιούνται για την αποστολή cookies στα προγράμματα περιήγησης των μελών σας. Στις περισσότερες περιπτώσεις, οι προεπιλεγμένες τιμές για τις ρυθμίσεις των cookies θα πρέπει να είναι επαρκείς. Αν χρειάζεται να αλλάξετε οποιοδήποτε να το κάνετε με προσοχή, εσφαλμένες ρυθμίσεις μπορεί να εμποδίσουν τα μέλη να συνδεθούν.',
...
$lang = array_merge($lang, array(
	...
	'UPLOAD_CERT_VALID'				=> 'Επικύρωση πιστοποιητικών μεταφόρτωσης',
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'Αν είναι ενεργό, τα πιστοποιητικά απομακρυσμένων μεταφορτώσεων θα επικυρωθούν. Αυτό απαιτεί τον καθορισμό της δέσμης CA στις ρυθμίσεις του <samp>openssl.cafile</samp> ή <samp>curl.cainfo</samp> στο php.ini.',
));
...
$lang = array_merge($lang, array(
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Προσδιορίστε ένα καταχωρημένο όνομα χρήστη ή μια έγκυρη JID. Το όνομα χρήστη δεν θα ελέγχεται για την εγκυρότητα. Εάν καθορίσετε μόνο ένα όνομα χρήστη, τότε το JID σας θα είναι το όνομα χρήστη και ο διακομιστής που καθορίζονται παραπάνω. Αλλιώς, καθορίστε ένα έγκυρο JID, για παράδειγμα user@jabber.org.',
));
