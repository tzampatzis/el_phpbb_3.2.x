...
$lang = array_merge($lang, array(
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Σημειώστε ότι πρέπει να παρέχετε και το πρωτόκολλο που χρησιμοποιεί ο διακομιστής σας. Αν χρησιμοποιείτε SSL, πρέπει να το γράψετε "ssl://your.mailserver.com"',
