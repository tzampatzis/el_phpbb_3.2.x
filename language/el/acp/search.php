...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_MYSQL_NOT_SUPPORTED'				=> 'Τα MySQL fulltext ευρετήρια μπορούν να χρησιμοποιηθούν μόνο με πίνακες MyISAM ή InnoDB. Η MySQL 5.6.4 ή νεότερη έκδοση απαιτείται για fulltext ευρετήρια σε πίνακες',
