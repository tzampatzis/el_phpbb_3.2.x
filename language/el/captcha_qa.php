...
$lang = array_merge($lang, array(
	...
	'QUESTIONS'					=> 'Ερωτήσεις',
	'QUESTIONS_EXPLAIN'			=> 'Για κάθε υποβολή φόρμας όπου έχετε ενεργοποιήσει τη μονάδα Q&amp;A, τα μέλη θα ερωτηθούν με μια από τις ερωτήσεις που καθορίζονται εδώ. Για να χρησιμοποιήσετε αυτή τη μονάδα τουλάχιστον μια ερώτηση πρέπει να οριστεί στην προεπιλεγμένη γλώσσα. Αυτές οι ερωτήσεις θα πρέπει να είναι εύκολες για το κοινό στο οποίο απευθύνονται για να απαντήσει, αλλά πέραν της ικανότητας ενός bot να μπορεί να λειτουργεί μια αναζήτηση στο Google™. Χρησιμοποιώντας ένα μεγάλο και τακτικά τροποποιημένο σύνολο ερωτήσεων θα αποφέρει τα καλύτερα αποτελέσματα. Ενεργοποιήστε τον αυστηρό έλεγχο αν η ερώτησή σας βασίζεται σε μικτή περίπτωση, στίξη ή κενά.',
